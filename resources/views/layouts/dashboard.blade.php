...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::is('users') || Request::is('users/*') || Request::is('roles') || Request::is('roles/*') || Request::is('permissions') || Request::is('permissions/*') ? 'active' : '' }}">
          <a href="#">
          ...
          <ul class="treeview-menu" style="{{ Request::is('users') || Request::is('users/*') || Request::is('roles') || Request::is('roles/*') || Request::is('permissions') || Request::is('permissions/*') ? '' : 'display: none;' }}">
            <li class="{{ Request::is('users') || Request::is('users/*') ? 'active' : '' }}"><a href="{{ url('/users')}}"><i class="fa fa-circle-o"></i> Users</a></li>
            <li class="{{ Request::is('roles') || Request::is('roles/*') ? 'active' : '' }}"><a href="{{ url('/roles')}}"><i class="fa fa-circle-o"></i> Roles</a></li>
            <li class="{{ Request::is('permissions') || Request::is('permissions/*') ? 'active' : '' }}"><a href="{{ url('/permissions')}}"><i class="fa fa-circle-o"></i> Permissions</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {{ \Carbon\Carbon::now()->year }} <a href="#">{{ config('app.name', 'Laravel') }}</a>.</strong> All rights
    reserved.
  </footer>
